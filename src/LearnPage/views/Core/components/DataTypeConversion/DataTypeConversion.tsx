...
function DataType() {
  return (
    <div style={{padding: 20}}>
      ...
      <iframe style={{width: '100%', height:400}} scrolling="no" title="Untitled" src="https://codepen.io/dagedan/embed/OJjzqqo?default-tab=js%2Cresult&editable=true&theme-id=dark" frameBorder="no" loading="lazy">
