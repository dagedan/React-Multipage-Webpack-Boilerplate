...
function BasePointThis() {
  return (
    <div style={{padding: 20}}>
      ...
      <h2>1.大多数情况下,函数的调用方式决定了this的值(运行时绑定),执行期间不允许给this赋值,每次函数调用时this的值也有可能不同.</h2>
      <h2>2.箭头函数不提供自身的this绑定,es5新增了bind方法设置this的值,而不用考虑函数如何被调用的.</h2>
      <h2>3.<a href="https://segmentfault.com/a/1190000011194676" target="_blank">关于this的显式绑定,隐式绑定,new绑定,默认绑定,箭头函数绑定的教学</a></h2>
