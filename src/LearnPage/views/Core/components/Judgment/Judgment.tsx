...
function DataTypeJudgment() {
  return (
    <div style={{ padding: 20 }}>
      ...
      <p>1.直接类型判断:Number/Boolean/String/Array/Function/Date/RegExp/Symbol/Error/Null/Undefined</p>
      ...
      <p>2.复杂类型判断:isElementObj/isEmptyObj/isPlainObj/isWindowObj/isArrayLike</p>
